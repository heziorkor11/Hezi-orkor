      ...
      {rows.length ? (
        <>
              ...
              >
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <button type="button" className="grid size-11 place-items-center rounded-md border border-line-strong" onClick={() => setQty(x.id, x.qty - 1)}>−</button>
          ...
          <div className="mt-4 rounded-xl border border-line bg-card p-4">
            ...
            <p className="mb-4 text-sm text-muted">התשלום בגרסת הדמו לא מחובר לסליקה. ההזמנה נשלחת אלינו בוואטסאפ לאישור.</p>
